...
SELECT r.flight_no, r.departure_airport, r.departure_airport_name, r.departure_city, r.arrival_airport, r.arrival_airport_name, r.arrival_city, a.model, r.duration, r.days_of_week
FROM routes r
